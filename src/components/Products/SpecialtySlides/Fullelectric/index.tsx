...
import styles from './Fullelectric.module.scss';
        ...
        <div className='acc-full-electrics-page'>
            ...
            <div className='acc-full-electrics-banner'>
                <CustomImage
                    ...
                    wrapClass={styles["acc-next-img-wc"]}
                />
                <Container>
                    <Row>
                        <Col lg={12} xs={7} >
                    ...
                    <div className="acc-slides-image-wrap w-75 mx-auto acc-slides-undermount position-relative">
                        ...
                        <ScrollAnimation animateIn="fadeIn">
                            <div className='acc-next-img acc-pdct-anim-img-dwr-sld-3100'>
                                <CustomImage src={fullelectrics.section3SliderImage.url} alt={fullelectrics.section3SliderImage.fileName} width={1014} height={624} objectFit="contain" />
                            </div>
                        </ScrollAnimation>
                    </div>
                    <ScrollAnimation animateIn="fadeIn" animateOnce>
