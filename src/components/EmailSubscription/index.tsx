...
import Image from "@Components/Utilities/CustomImage";
          ...
          <Container>
            ...
            >
              ...
              {/* <Button
                ...
                disabled={!inputFields.email.test(subscriberEmail)}
                block
                type="submit"
              ...
              <Button variant="primary" style={ifButtonActive ? { cursor: 'auto' } : {}} disabled={ifButtonActive} block type="submit" className="text-uppercase">Subscribe</Button>
