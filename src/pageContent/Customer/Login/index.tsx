...
const Login = () => {
  ...
  return (
    <>
      ...
      <section className={`${styles["preauth-bg"]} h-100 position-relative`}>
        ...
        <Container
          className={`section-padding ${
            styles["acc-login-custom-container-md"]
          } px-0 ${styles["form-gradient-bg"]} position-relative ${
            windowObj && windowSize.width < 1025 && "pt-0"
          }`}
        >
          <Row noGutters>
            {/* login */}
            <Col md={12} className={`bg-secondary ${styles["login-form"]}`}>
              <div
                className={`${styles["acc-login-custom-container-sm"]} py-4 px-3`}
              >
                ...
                <Form
                  ...
                  validated={validated}
                  onSubmit={loginForm}
                  className={styles["acc-login-custom-container-sm"]}
                >
                  <Form.Group>
                    <input
                      required
                  ...
                  <Form.Group className="position-relative">
                    ...
                    <Button
                      ...
                      variant="link"
                      type="button"
                      className={`${styles["acc-login-eye-bttn"]} p-0 font-size-lg`}
                    >
                  ...
                  <div className="d-flex align-items-center justify-content-between flex-sm-nowrap flex-wrap">
                    ...
                    >
                      <Button
                        ...
                        type="submit"
                        className={`text-uppercase ${styles["btn-primary-gradient"]}`}
                      >
                        Log in
                      </Button>
                    </div>
            ...
            <Col md={12} className="mt-4 text-center pb-3">
              <div
                className={`bg-primary h3 py-2 px-3 font-weight-300 ${styles["text-shadow"]}`}
              >
              ...
              <div className={styles["pro-advantage-wrap"]}>
                <div className="text-center py-5 position-relative px-4 px-md-0">
                  <I18nLink href="/proadvantage">
                    <Button variant="link" type="button" className="p-0">
                      ...
                      <span
                        className={`${styles["pro-advantage-hover"]} position-absolute`}
                      >
                        <span className={styles["unset-img"]}>
                          <CustomImage
                            layout="fill"
                            priority
                            objectFit="contain"
