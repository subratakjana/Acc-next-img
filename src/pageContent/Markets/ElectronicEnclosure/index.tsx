                  ...
                  <div className="acc-innovative-engineering-content position-relative mx-n3">
                    <div className="acc-background-image position-absolute">
                      <CustomImage
                        ...
                        fill
                        wrapClass={styles["acc-bg-img-wc"]}
                      />
                    </div>
                          ...
                          {windowObj && windowSize.width <= 767 && (
                            <div className="acc-background-image position-absolute">
                              <CustomImage
                                ...
                                alt="Background Image"
                                fill
                                wrapClass={styles["acc-bg-img-res-wc"]}
                              />
                            </div>
                          )}
                          <span className={styles["acc-background-image-wc"]}>
                            <CustomImage
                              ...
                              wrapClass={styles["acc-innovative-engineering-wc"]}
                            />                            
                          </span>
